...
HACK:=$(HACK) $(BUILDDIR)/SSDT-FAN-QUIET.aml $(BUILDDIR)/SSDT-FAN-MOD.aml $(BUILDDIR)/SSDT-FAN-SMOOTH.aml $(BUILDDIR)/SSDT-FAN-MEMPHIZ.aml
...
$(BUILDDIR)/SSDT-FAN-MEMPHIZ.aml : SSDT-FAN-QUIET.dsl
	iasl -D MEMPHIZ $(IASLOPTS) -p $@ $^
